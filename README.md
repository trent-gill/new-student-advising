...
Please be aware that this process is for students who **do not** need support in making decisions regarding their academic program (major, minor, etc.) and courses. Students who need more direct support should [make an appointment](/appointment) with an academic advisor.
...
At any time, you may also opt to [make an appointment](/appointment) with an academic advisor instead. Students who make appointments are also required to complete the New Student Advising video series.
